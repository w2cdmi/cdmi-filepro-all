...
public enum OperateDescription
{
    ENABLE_USER(1, "description.enable.user"), MODIFY_ADMIN(32, "description.admin.modify"), DELETE_APP(2,
        ...
        43, "admin.system.personalized"), ADMIN_UPLOAD(44, "admin.upload"), BIND_APP(46, "bind.app"), ADMIN_SYSLOG(
        47, "admn.syslog"), ADMIN_SET_ACCESS(48, "admn.set.access"), ADMIN_SET_STATISTICS_ACCESSKEY(49,
        "admin.set.statistics.accesskey"), PUBLISH_ANNOUNCEMENT(50, "publish.announcement"), DELETE_ANNOUNCEMENT(
        51, "delete.announcement"), CONFIG_ANNOUNCEMENT(52, "config.announcement"), ASYC_TASK_STOP(53,
        "asyc.task.stop"), ASYC_TASK_START(54, "asyc.task.start"), ENTERPRISE_INFO(55, "enterprise.info"), AUTHSERVER_TYPE_ADD(
        56, "authserver.type.add"), AUTHSERVER_TYPE_DELETE(57, "authserver.type.delete"), AUTHSERVER_TYPE_BIND_APP(
        58, "authserver.type.bind.app"), ADMIN_SET_AUTHENTICATION(59, "admin.set.authentication"), AUTHSERVER_FILTER_NODE(
        60, "authserver.filter.node"), ADMIN_CONFIG_NODE_FILTER(61, "admin.config.node.filter"), ADMIN_USER_SEARCH_RULE(
        62, "admin.user.search.rule"), ADMIN_FIELD_MAPPING(63, "admin.field.mapping"), ENTERPRISE_EMPLOYEES(
        64, "enterprise.employees.add"), ENTERPRISE_EMPLOYEES_OPEN_ACCOUNT(65,
        "enterprise.employees.open.account"), ENTERPRISE_EMPLOYEES_DELETE(66, "enterprise.employees.delete"), ENTERPRISE_EMPLOYEES_EXPORT(
        67, "enterprise.employees.export"), ENTERPRISE_EMPLOYEES_FAIL_EXPORT(68,
        "enterprise.employees.fail.export"), ENTERPRISE_EMPLOYEES_DELETE_FAIL_EXPORT(69,
        ...
        "system.role.set"), AUTHSERVER_TYPE_NETWORK_AUTH(95, "authserver.type.network.auth"), SYS_ADMIN_SET_SYSTEM_LOGINTIMES(
        96, "sys.admin.set.sys.logintimes"), SYS_ADMIN_SET_USER_LOGINTIMES(97,
        "sys.admin.set.user.logintimes"), ACCOUNT_BASIC_CONFIG(299, "account.basic.config"), SECURITY_LEVEL_DELETE(
        300, "security.level.delete"), SECURITY_LEVEL_ADD(301, "security.level.add"), SECURITY_LEVEL_UPDATE(
        302, "security.level.update"), RESOURCE_STRATEGY_DELETE(303, "resource.strategy.delete"), RESOURCE_STRATEGY_ADD(
        304, "resource.strategy.add"), RESOURCE_STRATEGY_UPDATE(305, "resource.strategy.update"), NETWORK_REGION_DELETE(
        306, "network.region.delete"), NETWORK_REGION_ADD(307, "network.region.add"), NETWORK_REGION_UPDATE(
        308, "network.region.update"), NETWORK_REGION_IP_DELETE(309, "network.region.ip.delete"), NETWORK_REGION_IP_UPDATE(
        310, "network.region.ip.update"), NETWORK_REGION_IP_ADD(311, "network.region.ip.add"), ACCESSCONFIG_SWITCH_CHANGE_OPEN(
        312, "accessconfig.switch.change.open"), ACCESSCONFIG_SWITCH_CHANGE_CLOSE(313,
        "accessconfig.switch.change.close"), ACCESSCONFIG_CHANGE(314, "accessconfig.change"), ACCESSCONFIG_ADD(
        ...
        336, "authserver.type.delete.app"), ADMIN_SYNCHRONIZE_USER_FAIL(337, "admin.synchronize.user.fail"), LOCK_MODIFY_PWD(
        350, "lock.modidy.pwd"), UNLOCK_MODIFY_PWD(351, "unlock.modify.pwd"), ACCOUNT_MODIFY_CONFIGURATION(
        2003, "account.modify"), ACCOUNT_STATUS(2005, "update.enterprise.account.status"), SYS_ADMIN_TEST_EMAIL(
        2006, "sys.admin.test.email"), ENTERPRISE_ADMIN_TEST_EMAIL(2007, "enterprise.admin.test.email"), CHECKCONFIG(
        2009, "check.config"), FORGET_PWD(2010, "forget.pwd.send.email"), USER_LOCK(100, "user.lock"), USER_UNLOCK(
        101, "user.unlock"), CREATE_SIGN_DECLARATION(2008, "create.sign.declaration"), UPDATE_LOGIN_CONFIG(
        2011, "update.login.config"), UPDATE_LOGIN_CONFIG_ERROR(2012, "update.login.config.error"), ADMIN_USERLOG_SET(
        2013, "admin.userlog.set"), ACCOUNT_MODIFY_CONFIGURATION_ERROR(2014, "account.modify.error"), AUTHAPP_NETWORK_REGION_STATUS(
        2015, "authapp.network.region.status");
