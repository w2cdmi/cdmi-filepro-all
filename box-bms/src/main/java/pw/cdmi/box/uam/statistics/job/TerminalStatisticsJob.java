...
public class TerminalStatisticsJob extends QuartzJobTask
{
     ...
     * 
     */
    private static final long serialVersionUID = 8422202347064476146L;
    ...
    {
        TerminalStatisticsDay terminalStatistics;
        StatisticsTerminal tempStatis;
        Integer count;
        for (Entry<StatisticsTerminal, Integer> entry : map.entrySet())
        {
