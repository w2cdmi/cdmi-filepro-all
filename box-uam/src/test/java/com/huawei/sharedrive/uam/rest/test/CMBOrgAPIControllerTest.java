...
public class CMBOrgAPIControllerTest
{
    private static final boolean showResult = true;
    
    // 列举用户相关请求体
    private static final String TEST_NORMAL_LIST_USERS = "testData/testCMBOrg.txt";
    ...
    public void getNormalUserInfo()
    {
        ...
        try
        {
            ...
            String urlString = Constants.SERVER_RUL + "/api/v2/cmb/org";
            URL url = null;
