...
import com.huawei.sharedrive.uam.log.domain.UserLogRes;
...
public class UserLogServiceImpl implements UserLogService
{
    ...
    @Override
    public void saveFailLog(UserLog userLog, String loginName, String appId, String[] params,
        UserLogType logType)
    {
        try
        {
    ...
    @Override
    public void saveFailLog(UserLog userLog, UserLogType logType, String[] params)
    {
        boolean isContinue = unsaveLog(logType);
        if (!isContinue)
        {
