...
public enum OperateType
{
    ...
    Uncertain(-1, "ALL_LOG"), Login(1, "ADMIN_LOGIN"), Logout(2, "ADMIN_LOGOUT"), ResetPassword(3,
        ...
        92, "ADMIN_CHANGE_TEAM_VERSIONS"), UpdateUser(102, "ADMIN_UPDATE_USER"), SyncUser(105,
        ...
        "ADMIN_ENABLE"), AdminDisable(114, "ADMIN_DISABLE"), AdminLogSet(115, "ADMIN_LOG_SET"), UpdateEnterpriseStatus(
        116, "UPDATE_ENTERPRISE_STATUS"), BindApp(117, "BIND_APP"), ChangeStatisticsAccesskey(118,
        "ADMIN_SET_STATISTICS_ACCESSKEY"), SystemAnnouncement(119, "SYSTEM_ANNOUNCEMENT"), AsyncTask(120,
        "ASYNC_TASK"), EnterpriseInfo(121, "ENTERPRISE_INFO"), AuthserverType(122, "AUTHSERVER_TYPE"), EnterpriseEmployees(
        123, "ENTERPRISE_EMPLOYEES"), UserStatusUpdate(124, "USER_STATUS_UPDATE"), SecurityAccessControlRole(
        125, "SECURITY_ACCESS_CONTROL_ROLE"), WaterMark(126, "WATER_MARK"), SystemRole(127, "SYSTEM_ROLE"), SecurityLevel(
        300, "SECURITY_LEVEL"), ResourceStrategy(302, "RESOURCE_STRATEGY"), NetworkRegion(303,
        "NETWORK_REGION"), NetworkRegionIp(304, "NETWORK_REGION_CONFIG_IP"), AccessConfig(305, "ACCESSCONFIG"), AccessSpaceConfig(
        306, "ACCESSCONFIG_SPACE"), AccessFileCopyConfig(307, "ACCESSCONFIG_FILECOPY"), Statistics(308,
        "STATISTICS"), AccountBasicManage(309, "ACCOUNT_BASIC_MANAGE"), LockModifyPassword(310,
        "LOCK_MODIFY_PWD"), UnlockModifyPassword(311, "UNLOCK_MODIFY_PWD"), SendTestEmail(312,
        "ADMIN_SEND_TEST_EMAIL"), Lock(8, "USER_LOCK"), Unlock(9, "USER_UNLOCK");
    ...
    public static int setLogLevel(int code)
    {
        ...
        int medium = 1;
        int low = 0;
        Map<Integer, Integer> level = new HashMap<Integer, Integer>(10);
        ...
        level.put(OperateType.UpdateEnterpriseStatus.getCode(), high);
