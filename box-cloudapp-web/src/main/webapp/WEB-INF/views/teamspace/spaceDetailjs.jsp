...
<script type="text/javascript">
    ...
    var filelabelSearch = new FilelabelAdmin(curUserId, 2, '${token}');
    ...
    function chooseDocType() {
        var vthis = $(this);
        var conditionArea = $('div.high-search-type');
        vdocId = vthis.attr("value"), vdocName = vthis.text();
    ...
    function showBindFileLabelUI(nodeId, createdBy) {
        var teamspaceRole = '${memberInfo.teamRole}';
        if (teamspaceRole == 'admin' || teamspaceRole == 'manager' || (createdBy && createdBy == curUserId)) {
            var url = '${ctx}/filelabel/showBindFilelabelView?bindType=2&nodeId=' + nodeId + '&ownerId=' + ownerId;
            ...
            handlePrompt("error", "<spring:message code='fl.bind.noPermission'/>");
        }
    }
