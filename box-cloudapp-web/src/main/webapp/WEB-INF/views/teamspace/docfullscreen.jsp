...
<%
    // 原有邏輯沒有加basePath,本地測試如果不是/為ContextPath，而是以/cloudapp為ContextPath則會報找不到圖片。 上面有"ctx"。
...
<head>
    ...
    <style>
        ...
        .fullscreen .content .img .prev {
            left: 20px;
            cursor: url(${ctx}/static/skins/default/img/arrow_left.ico), default;
        }

        .fullscreen .content .img .next {
            right: 20px;
            cursor: url(${ctx}/static/skins/default/img/arrow_right.ico), default;
        }
        ...
        .tool_bar_page .tb-prev .tb-prev-icon, .tool_bar_page .tb-prev {
            ...
            width: 24px;
            height: 24px;
            background: url(${ctx}/static/skins/default/img/arrow_left_m.png) no-repeat 0 0;
        }
        ...
        .tb-next-icon {
            ...
            width: 24px;
            height: 24px;
            background: url(${ctx}/static/skins/default/img/arrow_right_m.png) no-repeat 0 0;
        }
        ...
        .tb-zoom span {
            ...
            width: 24px;
            height: 24px;
            background: #fff url(${ctx}/static/skins/default/img/full_screen.png) no-repeat 0 0;
            margin-top: 5px;
            border-radius: 3px;
        }

        .tb-zoomin span {
            background-image: url(${ctx}/static/skins/default/img/full_screen_exit.png);
        }
            ...
            <div class="fullscreen">
                <div class="fullscreen_max">
                    <div class="content content_h1 content_min">
                        <div class="img">
                            <img id="doc_ppt_img" src="1.jpg" alt="" width="100%" height="100%"/>
