...
<div class="pop-content copyAndMove-con">
    ...
    <input type="hidden" id="nodeName" name="nodeName" value="<c:out value='${nodeName}'/>"/>
...
<script type="text/javascript">
    ...
    var zNodes = [{id: folderId, name: nodeName, ownedBy: destOwnerId, open: true, isParent: true}];
