...
(function() {
	...
	var _createPage = function(target, opts){
		...
		var pageSkip = '<div id="'+ _idMap.pageSkipId +'" class="page-skip pull-right form-search"><span class="page-skip-text">'+ _text.pageSkip +'</span>'+
						'<div class="input-append"><input id="'+ _idMap.pageSkipTextId +'" class="search-query span1" type="text" onkeyup="this.value=this.value.replace(/[^0-9]*$/,\'\')" ondragenter="return false" onpaste="return !clipboardData.getData(\'text\').match(/\D/)" /><button class="btn" id="'+ _idMap.pageSkipBtnId +'" type="button"><i class="icon-br-next"></i></button></div>'+
						'</div>';
