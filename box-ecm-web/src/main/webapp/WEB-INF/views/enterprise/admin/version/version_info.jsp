...
<meta charset="UTF-8">
<title>Title</title>
<link href="${ctx}/static/enterprise/version/version_info.css" type="text/css" rel="stylesheet">
<script src="${ctx}/static/enterprise/version/version_info.js"></script>
 <script type="text/javascript">
   ...
   function saveCorpright(){
    	...
    	$("#corprightForm").attr("action", "${ctx}/enterprise/admin/individual/config/saveCorpright?appId="+window.parent.defaltAppId);
...
<div class="content">
    ...
    <div class="c_main">
                ...
                <div class="option-content" id="personal" style="display: block">
                  <!--个性化-->
