...
Page({
    ...
    onLoad: function (options) {
        ...
        if (linkCode != undefined && linkCode != '' && forwardId != undefined && forwardId != "") {
            ...
            forwardId = ownerId;
            wx.navigateTo({
                url: '/disk/shares/sharefile?ownerId=' + ownerId + '&nodeId=' + nodeId,
            })
        }
        //收件箱跳转
    ...
    onShow: function () {
        ...
        if (forwardId != undefined && forwardId != 0) {
            session.login({
                enterpriseId: 0,
    ...
    onShareAppMessage: function (e) {
        ...
        if (fileInfo.linkCode != undefined && fileInfo.linkCode != "") {
            ...
            url = '/disk/index?linkCode=' + fileInfo.linkCode + "&forwardId=" + getApp().globalData.cloudUserId;
        } else {
            ...
            url = '/disk/index?ownerId=' + fileInfo.ownerId + "&nodeId=" + fileInfo.nodeId;
        }
