...
Page({
  ...
  data: {
    ...
    validityDate: '1',      //有效时间  1: 一天  7: 七天   0: 永久
  ...
  onShareAppMessage: function (e) {
    ...
    return {
      title: "",
      path: '/disk/index?linkCode=' + params.linkCode + '&forwardId=' + params.forwardId + "&type=" + page.data.shareType + "&plainAccessCode=" + page.data.extractionCode,
      imageUrl: "",
      success: function (res) {
        wx.navigateBack({
          delta: 1
