# DSP(非结构化数据服务平台)-SRM(存储路由调度模块)

------------------------------------
**部署备注**
在部署SRM模块时候，请在挂载目录下创建一个temp目录，将check_readable_file_7471417624053548979.tmp文件放入其中。
并且给予temp目录读写权限，手动安装建议设置为750。
------------------------------------
**Version**：1.5.4.21
**修订时间**：2017-11-25
###**新增特性**：Office文档在线编辑
...
#1.5.43 20180112
此版本完善了腾迅云支持
(更新代码的时候需要在system_config表中support.filesystem.types 加'tencent_cloud_cos')
