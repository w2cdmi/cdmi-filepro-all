...
public class DGUFMTTransportManagerConfig extends TTransportManagerConfig
{
    @Override
    public ThriftServiceAddress getLoadBalanceAddress()
    {
        ...
        String serverIp = SystemConfigContainer.getString(SystemConfigKeys.DG_THRIFT_APPSERVER_SERVER_IP,
            "127.0.0.1");
