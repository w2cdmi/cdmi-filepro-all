...
public class UFMTTransportManagerConfig extends TTransportManagerConfig
{
    @Override
    public ThriftServiceAddress getLoadBalanceAddress()
    {
        ...
        String serverIp = SystemConfigContainer.getString(SystemConfigKeys.THRIFT_APPSERVER_SERVER_IP,
            "127.0.0.1");
